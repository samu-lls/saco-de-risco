export const SHOP_ITEMS = [
  ...
  { id: 'patch', name: 'Patch de Seg.', type: 'heal', cost: { green: 0, blue: 1, yellow: 2 }, desc: 'Recupera +1 HP instantaneamente. (MÁX: 4 HP)' },
  { id: 'vpn', name: 'VPN', type: 'utility', cost: { green: 1, blue: 1, yellow: 1 }, desc: 'Pula seu turno imediatamente com segurança.' },
  { id: 'trojan', name: 'Trojan', type: 'attack', cost: { green: 2, blue: 1, yellow: 0 }, desc: 'Força um alvo a sacar 6 vezes no turno dele.' },
  ...
  { id: 'ddos', name: 'DDoS Automático', type: 'fatal', cost: { green: 2, blue: 1, yellow: 2 }, desc: 'Aplica +4 Saques Obrigatórios em TODOS.' },
